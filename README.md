...
- `templates/budget_input_template.csv`：可直接复用的预算/实际填报模板（示例行）。
...
1. 按 `templates/budget_input_template.csv` 统一业务填报字段。
2. 按 `docs/enterprise_budget_template_guide.md` 做数据校验。
